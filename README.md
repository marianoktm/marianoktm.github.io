...
Tools and Platforms: 
JetBrains Suite (CLion, IntelliJ, PyCharm, WebStorm, DataGrip), Linux (Mint, Ubuntu, Manjaro, CentOS), Oracle VirtualBox, Git Hub, Hardhat, Overleaf, Dia Diagram Editor, Unity, Xcode;

Languages, Libraries and Frameworks:
- C: RDMA-Core, Socket API, POSIX Threads, OpenMP, unistd.h, libc;
- C++: CUDA, OpenCV, STL;
- Databases: SQL (PL/SQL, MySQL), NoSQL (MongoDB);
- Java: JDBC, JavaFX;
- Python: Flask, Werkzeug, Jinja, PyMongo;
- Web: JavaScript (Node.js, Web3.js), Solidity (OpenZeppelin), HTML/CSS (Bootstrap);
- Other: LaTeX, Go, MATLAB, C#, Swift.
